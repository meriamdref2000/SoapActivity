    ...
    extends Service
{
     ...
     * 
     * @return
     *     returns BanqueSerice
     */
    @WebEndpoint(name = "BanqueSericePort")
    public BanqueSerice getBanqueSericePort() {
        return super.getPort(new QName("http://ws/", "BanqueSericePort"), BanqueSerice.class);
    }
     ...
     */
    @WebEndpoint(name = "BanqueSericePort")
    public BanqueSerice getBanqueSericePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "BanqueSericePort"), BanqueSerice.class, features);
    }
